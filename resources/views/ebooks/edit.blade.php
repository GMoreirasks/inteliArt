...
<body class="bg-white text-black min-h-screen flex flex-col items-center">
    ...
    <div class="w-full max-w-4xl p-6">
        <div class="text-center space-y-6">
            <h1 class="text-4xl font-bold text-[#293039]">Editar eBook</h1>
            ...
            <form action="{{ route('ebooks.update', $ebook) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <textarea name="description" id="description" required
                              class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">{{ old('description', $ebook->description) }}</textarea>
                </div>
